...
export class Initial1587924544893 implements MigrationInterface {
    name = 'Initial1587924544893'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `format` (`id` bigint NOT NULL AUTO_INCREMENT, `type` enum ('epub', 'kindle', 'text', 'html', 'pdf') NOT NULL, `file` varchar(255) NOT NULL, `description` varchar(255) NULL, `edition_id` bigint NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `identifier` (`id` bigint NOT NULL AUTO_INCREMENT, `source` enum ('project_gutenberg', 'goodreads', 'global') NOT NULL, `type` enum ('isbn', 'isbn13', 'internal') NOT NULL, `value` varchar(255) NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `edition_id` bigint NULL, `book_id` bigint NULL, `entity_type` varchar(255) NOT NULL, UNIQUE INDEX `IDX_00f1dc27fdd66f354398f78cf9` (`entity_type`, `source`, `type`, `value`), INDEX `IDX_d8d5883a07f381e96a35bb7546` (`entity_type`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("CREATE TABLE `edition` (`id` bigint NOT NULL AUTO_INCREMENT, `book_id` bigint NOT NULL, `title` varchar(255) NOT NULL, `subtitle` longtext NULL, `language_id` bigint NOT NULL, `downloads` int NOT NULL, `published_at` datetime NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("CREATE TABLE `taxon` (`id` bigint NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `taxonomy_id` bigint NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `book` (`id` bigint NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `subtitle` longtext NULL, `description` longtext NOT NULL DEFAULT '', `rating` decimal(3,2) NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
